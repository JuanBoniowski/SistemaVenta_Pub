...
namespace SistemaVenta.BLL.Implementacion
{
    ...
    {
    private readonly IGenericRepository<Negocio> _respositorio;
    private readonly IFireBaseService _firebaseService;

        public NegocioService(IGenericRepository<Negocio> respositorio, IFireBaseService firebaseService)
        {
        ...
        public async Task<Negocio> Obtener()
        {
            try
            {
                Negocio negocio_encontrado = await _respositorio.Obtener(n => n.IdNegocio == 1);
        ...
        public async Task<Negocio> GuardarCambios(Negocio entidad, Stream Logo = null, string NombreLogo = "")
        {
            try
            {
                ...
                await _respositorio.Editar(negocio_encontrado);
                return negocio_encontrado; 
            }
            catch 
            {
